        ...
        <div className="sticky top-0 z-50 bg-slate-700 border-b-4 border-blue-400 shadow-lg">
            ...
            */}
            ...
            <button
                ...
                className="absolute -bottom-1 right-4 translate-y-full pixel-font bg-slate-700 text-blue-300 hover:text-white border-4 border-t-0 border-blue-400 transition-colors no-outline"
